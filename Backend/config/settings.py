...
# 1. Definir la ruta primero
BASE_DIR = Path(__file__).resolve().parent.parent

# 2. Inicializar el entorno
env = environ.Env()

# 3. Leer el archivo usando la ruta ya definida
environ.Env.read_env(os.path.join(BASE_DIR, 'claves.env'))
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(hours=8),   # Un turno de trabajo
